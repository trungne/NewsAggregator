...
public class RetrieveInBodyTag implements DateTimeRetrievable{

    @Override
    public String getDateTimeString(Document doc, String propertyContainsDateTimeInfo) {
        Elements dateTimeTags = doc.getElementsByClass(propertyContainsDateTimeInfo);
        return getDateTimeSubString(dateTimeTags.text());
